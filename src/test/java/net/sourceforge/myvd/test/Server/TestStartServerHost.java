...
public class TestStartServerHost {
    ...
    public static void setUp() throws Exception {
        ...
        server.startServer(System.getenv("PROJ_DIR") + "/test/TestServer/testconfig-host.props", 50983);
    ...
    @Test
    public void testStartServer_BindWithCredentials() throws Exception {
    ...
    @Test
    public void testStartServer_BindWithoutCredentials() throws Exception {
        LDAPConnection con = new LDAPConnection();
        con.connect("127.0.0.1", 50983);
