...
public class PBKDF2
{
	public static String generateHash(String password) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
		return generateHash(password,16);
	}
	
	public static String generateHash(String password,int saltSize) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
    	...
    	int saltSize = Integer.parseInt(args[1]);
    	System.out.println(PBKDF2.generateHash(password, saltSize));
    }
