...
public class BindRequestHandler extends LdapRequestHandler<BindRequest>
{
    ...
    public BindRequestHandler(boolean authRequired) {
    ...
    public void handleSimpleAuth( LdapSession ldapSession, BindRequest bindRequest ) throws Exception
    {
        ...
        try
        {
            ...
            //MyVD doesn't need to do a lookup
            /*try
            {
            ...
            ( ( DefaultCoreSessionImpl ) coreSession ).setIoSession( bindContext.getIoSession() );

            if (authRequired && (bindRequest.getDn() == null || bindRequest.getDn().getNormName().isEmpty())) {
                bindRequest.setSaslMechanism("Anonymous");
        ...
        try
        {
            ...
            if ( ss.isComplete() )
            {
                ...
                if ( ldapPrincipal != null )
                {
                    ...
                    // Store the IoSession in the coreSession
                    ( ( DefaultCoreSessionImpl ) userSession ).setIoSession( ldapSession.getIoSession() );
                }
